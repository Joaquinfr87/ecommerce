      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Tu proveedor confiable de repuestos y accesorios para bicicletas y
            motos desde 2010.
          </p>
        </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div>
              <p className="text-gray-600 mb-4">
                Todo comenzó en un pequeño taller en el centro de la ciudad,
                donde nuestro fundador, Juan Pérez, identificó la necesidad de
                un proveedor confiable de repuestos para bicicletas y motos.
              </p>
              <p className="text-gray-600 mb-4">
                Lo que empezó como un negocio familiar se ha convertido en una
                de las distribuidoras más importantes de la región, gracias a
                nuestro compromiso con la calidad y servicio al cliente.
              </p>
              <p className="text-gray-600">
                Hoy operamos con 3 tiendas físicas y nuestra plataforma online
                que atiende a todo el país.
              </p>
            </div>
            <div className="bg-gray-200 h-64 rounded-lg flex items-center justify-center">
              <span className="text-gray-500">
                [Imagen de tu taller o equipo]
              </span>
            </div>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              },
              {
                ...
                description:
                  "Nuestro equipo tiene más de 50 años de experiencia combinada.",
                icon: "🔧",
              },
              {
                title: "Servicio Personalizado",
                description:
                  "Te asesoramos para encontrar exactamente lo que necesitas.",
                icon: "💬",
              },
            ].map((value, index) => (
              <div
        ...
        <div className="text-center bg-blue-50 p-8 rounded-xl">
          <h2 className="text-2xl font-bold text-gray-800 mb-4">
            ¿Listo para encontrar los repuestos que necesitas?
          </h2>
