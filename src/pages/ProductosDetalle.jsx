  ...
  if(!product){
    return (<div className="container mx-auto px-4 py-8">
      <div className="text-center">
        ...
        <Link to="/" className="text-blue-600 hover:text-blue-800">Retornar a Pagina de Inicio</Link>
      </div> 
    </div>);
  }
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
        ...
        <div>
          ...
          <div className="mb-6">
            ...
            <span className="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm">{product.categoria}</span>
          </div>
